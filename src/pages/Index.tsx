...
import { Check, Clock, Phone, Calendar, TrendingUp, Users, Zap, Shield, Target, ArrowRight, Play, Star, Award, CheckCircle } from "lucide-react";
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold text-blue-600">
            Invoicce<span className="text-gray-700">.AI</span>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col lg:flex-row gap-6 justify-center items-center mb-16">
            <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 text-lg rounded-lg font-semibold">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="bg-red-50 border-l-4 border-l-red-500 p-8 rounded-lg">
              <h3 className="text-xl font-bold text-red-600 mb-4">O resultado que você conhece bem:</h3>
              <p className="text-lg text-gray-700 leading-relaxed">
                Leads esfriam nos finais de semana. Equipe não atende fora do horário. Cliente interessado à noite vira concorrência na segunda-feira. 
                <span className="font-bold"> Você paga para gerar leads e deixa 70% deles escaparem.</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-bold text-center text-gray-900 mb-16">
              A solução que você estava esperando: <span className="text-blue-600">substituição total da equipe</span>
            </h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-gray-50 p-10 rounded-2xl">
                <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Antes vs Depois</h3>
                <div className="space-y-6">
                  <div className="flex justify-between items-center p-4 bg-white rounded-lg">
                    <span className="text-gray-700 font-medium">Tempo de resposta:</span>
                ...
                <CardContent className="p-0">
                  ...
                  <ul className="space-y-4 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <span className="text-lg">Já investe em marketing e quer converter melhor</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="mr-3 h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                      <span className="text-lg">Quer eliminar custos trabalhistas</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="mr-3 h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                      <span className="text-lg">Tem processo comercial estruturado</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="mr-3 h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                      <span className="text-lg">Busca resultados rápidos e mensuráveis</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-0">
                  ...
                  <ul className="space-y-4 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <span className="text-lg">Prefere manter equipe humana tradicional</span>
                    </li>
                    <li className="flex items-start">
                      <span className="mr-3 text-red-500 mt-1 text-xl">✗</span>
                      <span className="text-lg">Aceita perder leads fora do horário</span>
                    </li>
                    <li className="flex items-start">
                      <span className="mr-3 text-red-500 mt-1 text-xl">✗</span>
                      <span className="text-lg">Não tem interesse em medir retorno</span>
                    </li>
                    <li className="flex items-start">
                      <span className="mr-3 text-red-500 mt-1 text-xl">✗</span>
                      <span className="text-lg">Quer continuar pagando encargos trabalhistas</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-bold text-center text-gray-900 mb-12">
              Dados que <span className="text-red-600">comprovam a urgência</span>
            </h2>
            <div className="bg-blue-50 p-8 rounded-2xl mb-12">
              <div className="flex items-center justify-center mb-6">
                <img src="/api/placeholder/120/40" alt="HubSpot Research" className="h-10" />
                <span className="ml-4 text-lg font-semibold text-gray-700">Pesquisa Oficial HubSpot 2024</span>
              </div>
              <p className="text-center text-xl text-gray-700 mb-8">
                Como o interesse do lead diminui drasticamente a cada minuto sem resposta
              </p>
            </div>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="bg-gray-50 p-10 rounded-2xl">
                <h3 className="text-2xl font-bold mb-8 text-center text-gray-900">Taxa de Conversão por Tempo de Resposta</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 bg-green-100 rounded-lg">
                    <span className="font-semibold text-gray-900">0-5 minutos</span>
                  ...
                  <div className="flex justify-between items-center p-4 bg-red-100 rounded-lg">
                    <span className="font-semibold text-gray-900">Mais de 24 horas</span>
                    <div className="flex items-center">
              ...
              <div>
                <div className="bg-red-50 border-l-4 border-l-red-500 p-8 rounded-lg mb-8">
                  <h3 className="font-bold text-red-600 text-2xl mb-4">A verdade que ninguém quer ver:</h3>
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Você investe milhares para gerar leads interessados. E perde 95% deles porque sua equipe só trabalha 
                    8 horas por dia, não atende fim de semana e demora para responder.
                  </p>
                </div>
                
                <div className="bg-gray-900 text-white p-8 rounded-xl">
                  <h3 className="font-bold text-yellow-400 text-2xl mb-6">Calculadora da Sua Perda Mensal:</h3>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-16">
              {[
                ...
                <Card key={index} className="p-8 border-l-4 border-l-green-500 bg-white">
                  <CardContent className="p-0 text-center">
                    <div className="text-5xl font-bold text-green-600 mb-4">{item.metric}</div>
                    <h3 className="font-bold text-gray-900 text-xl mb-3">{item.title}</h3>
                    <p className="text-gray-600 mb-4 text-lg">{item.desc}</p>
                    <Badge variant="outline" className="text-sm font-medium">{item.company}</Badge>
                  </CardContent>
                </Card>
              ))}
            </div>
            ...
            <div className="bg-white p-10 rounded-2xl border border-gray-200">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                ...
                <div className="p-4">
                  <div className="text-3xl font-bold text-yellow-600 mb-2">28s</div>
                  <div className="text-gray-600">Tempo médio resposta</div>
                </div>
                <div className="p-4">
                  <div className="text-3xl font-bold text-purple-600 mb-2">71.4%</div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-4xl lg:text-5xl font-bold mb-12">
              Imagine sua empresa vendendo <span className="text-yellow-300">sem você precisar estar presente</span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
              <div className="bg-white/10 p-8 rounded-xl backdrop-blur">
                <h3 className="font-bold text-xl mb-4">Segunda-feira, 8h da manhã:</h3>
                <p className="text-gray-300 leading-relaxed">
                  Você abre o computador e encontra 15 reuniões já agendadas para a semana. 
                  Sua IA trabalhou no fim de semana enquanto você descansava com a família.
                </p>
              </div>
              <div className="bg-white/10 p-8 rounded-xl backdrop-blur">
                <h3 className="font-bold text-xl mb-4">Sua equipe de vendas:</h3>
                <p className="text-gray-300 leading-relaxed">
                  Só recebe reuniões qualificadas. Sem perder tempo com lead frio. 
                  Sem pressão por velocidade. Sem desperdiçar seu investimento em tráfego.
                </p>
              </div>
              <div className="bg-white/10 p-8 rounded-xl backdrop-blur">
                <h3 className="font-bold text-xl mb-4">Seu retorno sobre investimento:</h3>
                <p className="text-gray-300 leading-relaxed">
                  Cada real investido em marketing agora tem retorno garantido. 
                  Leads não esfriam mais. Oportunidades não escapam. Vendas acontecem.
                </p>
              </div>
              <div className="bg-white/10 p-8 rounded-xl backdrop-blur">
                <h3 className="font-bold text-xl mb-4">Sua tranquilidade total:</h3>
                <p className="text-gray-300 leading-relaxed">
                  Fim de semana, feriado, madrugada - sua empresa vende 24 horas por dia 
                  com a mesma qualidade e eficiência. Sem dor de cabeça trabalhista.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="mb-6 bg-orange-500 text-white px-8 py-3 text-lg font-semibold rounded-full">
            ...
            <div className="bg-white p-12 rounded-2xl text-gray-900 mb-12">
              <h3 className="text-2xl font-bold mb-8">Na demonstração você vai ver:</h3>
            ...
            <Button size="lg" className="bg-green-600 hover:bg-green-700 text-white px-12 py-6 text-xl font-bold rounded-xl">
              <Calendar className="mr-4 h-6 w-6" />
              AGENDAR DEMONSTRAÇÃO GRATUITA
            </Button>
            
            <p className="text-sm opacity-75 mt-6">
              Demonstração de 30 minutos • Sem compromisso • Resposta em até 2 horas
            </p>
          </div>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  answer: "Absolutamente não. Nossa conversação é 100% natural e foi validada em mais de 10.000 ligações reais com clientes de diversos setores. Os prospects não conseguem distinguir da conversa humana porque desenvolvemos scripts personalizados para cada tipo de negócio."
                },
                {
                  question: "O investimento não é alto demais para minha empresa?",
                  answer: "Pelo contrário. O investimento mensal é menor que o salário de 1 funcionário CLT (sem contar encargos, férias, 13º, FGTS) e trabalha 3x mais horas. Nossos clientes recuperam o investimento em 30-60 dias através do aumento de conversão."
                },
                {
                  question: "Se já tenho equipe comercial, por que preciso da IA?",
                  answer: "Para cobrir exatamente o que sua equipe humana não consegue: madrugada, fim de semana, férias, feriados. Sua equipe fica livre para focar apenas em reuniões qualificadas, não em prospecção básica e correria para responder leads."
                },
                {
                  question: "Quanto tempo demora para começar a ver resultados?",
                  answer: "Implementação completa em até 48 horas. Primeiros resultados aparecem em 72 horas. ROI positivo comprovado em 30 dias. Nossos clientes veem aumento médio de 35% na conversão já no primeiro mês de uso."
                },
                {
                  question: "Funciona para qualquer tipo de negócio?",
                  answer: "Funciona melhor para empresas B2B com valor de venda a partir de R$ 2.000 e processo comercial estruturado. Indústria, energia solar, saúde corporativa e telecom são nossos casos de maior sucesso, mas adaptamos para diversos setores."
                },
                {
                  question: "E se meu sistema for diferente dos outros?",
                  answer: "Integramos com qualquer CRM ou sistema: HubSpot, Salesforce, Pipedrive, RD Station, ou até sistema proprietário desenvolvido internamente. Nossa equipe técnica especializada cuida de toda a integração sem complicação."
                }
              ].map((faq, index) => (
                <Card key={index} className="p-8 border-l-4 border-l-blue-500 bg-white">
                  <CardContent className="p-0">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center">
            <div className="text-3xl font-bold text-blue-400 mb-6">
              Invoicce<span className="text-gray-400">.AI</span>
            </div>
            <p className="text-gray-400 mb-12 text-lg">
              A solução de IA que substitui sua equipe de atendimento e vende 24 horas por dia
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
              <div className="p-6">
                <h4 className="font-bold mb-3 text-lg">Implementação Express</h4>
                <p className="text-gray-400">48 horas para estar vendendo</p>
              </div>
              <div className="p-6">
                <h4 className="font-bold mb-3 text-lg">Suporte Dedicado</h4>
                <p className="text-gray-400">Time especializado sempre disponível</p>
              </div>
              <div className="p-6">
